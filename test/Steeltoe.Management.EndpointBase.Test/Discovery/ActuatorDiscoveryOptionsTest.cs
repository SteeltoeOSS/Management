...
{
    public class ActuatorDiscoveryOptionsTest : BaseTest
    {
        [Fact]
        ...
        public void Contstructor_ThrowsIfConfigNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ActuatorDiscoveryEndpointOptions(config));
        }
        ...
        public void Contstructor_BindsConfigurationCorrectly()
        {
            ...
            var actOpts = new ActuatorDiscoveryEndpointOptions(config);
