...
namespace Steeltoe.Management.Endpoint.Discovery.Test
{
    public class EndpointMiddlewareTest : BaseTest
    {
        ...
        public async void HandleCloudFoundryRequestAsync_ReturnsExpected()
        {
            ...
            var ep = new TestDiscoveryEndpoint(opts, mgmtOpts);
            var middle = new ActuatorDiscoveryEndpointMiddleware(null, ep, mgmtOpts);
...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        [Fact]
        public async void DiscoveryEndpointMiddleware_ServiceContractNotBroken()
        {
        ...
        [Fact]
        public void ActuatorDiscoveryEndpointMiddleware_PathAndVerbMatching_ReturnsExpected()
        {
            var opts = new ActuatorDiscoveryEndpointOptions();
            var actmOpts = new ActuatorManagementOptions();
            var mgmtOpts = new List<IManagementOptions> { actmOpts };

            var ep = new ActuatorDiscoveryEndpoint(opts, mgmtOpts);
