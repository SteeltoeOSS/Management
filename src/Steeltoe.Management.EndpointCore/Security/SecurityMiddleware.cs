...
namespace Steeltoe.Management.Endpoint.Security
{
    public class SecurityMiddleware
    {
        ...
        public SecurityMiddleware(RequestDelegate next, IActuatorDiscoveryOptions options, IManagementOptions actuatorManagementOptions, ILogger<SecurityMiddleware> logger)
        {
            _next = next;
            _logger = logger;
            _options = options;
